...
<input type="checkbox" id="chords_checkbox" checked><label for="chords_checkbox">Sointumerkit</label>
<span id="chords_select_span">
: <select id='chords_select_element'></select>
<!--
<button>&lt</button><button>&gt</button>
-->
</span>
&nbsp;&nbsp;