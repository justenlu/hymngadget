...
function UnknownMarking(marking) {
	this.marking=marking;
}

UnknownMarking.prototype.toString = function() {
	return "Unknown marking: "+this.marking;
}

UnknownMarking.prototype.clone = function() {
	return new UnknownMarking(this.marking);
}